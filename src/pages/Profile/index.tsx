...
import { KeyboardAvoidingView, Platform, View, TextInput, Alert, TouchableOpacity } from 'react-native';
...
const Profile: React.FC = () => {
  ...
  const pickImage = useCallback(async () => {
    ...
    if (!result.cancelled) {
      ...
      data.append('avatar', { type: 'image/jpeg', uri: localUrl, name: `${localUrl}` })
